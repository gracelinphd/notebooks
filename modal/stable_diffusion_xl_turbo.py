...
Source: https://modal.com/docs/examples/stable_diffusion_xl_turbo

To run: 
>modal run stable_diffusion_xl_turbo.py --prompt="harry potter, glasses, wizard" --image-path="dog.png"

Note that we specified the location of the image: dog.png.
The output is automatically saved to a tmp directory (see returned message).
Copied it to the local directory for reference: output.png.
"""
